...
<form action="${pageContext.request.contextPath }/fboard/fwritePro" method="post" enctype="multipart/form-data">
<table id="notice">
<tr><td>이름</td>
...
onclick="location.href='${pageContext.request.contextPath }/fboard/flist'">
</div>
</form>
